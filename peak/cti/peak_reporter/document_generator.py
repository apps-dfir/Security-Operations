...
def build_markdown(inp: ReportInputs) -> str:
    ...
    lines.append("## Analyst Assessment (Fill In)")
    lines.append("")
    lines.append("### Key Findings")
    lines.append("<!-- Delete placeholder text and fill in -->")
    lines.append("- **What happened:** ")
    lines.append("- **Who is affected:** ")
    lines.append("- **Threat actor (if known):** ")
    lines.append("- **Campaign/operation name:** ")
    lines.append("")
    lines.append("### Risk Assessment")
    lines.append("| Factor | Rating | Notes |")
    lines.append("|--------|--------|-------|")
    lines.append("| Relevance to org | Low / Med / High | |")
    lines.append("| Threat severity | Low / Med / High | |")
    lines.append("| Confidence in intel | Low / Med / High | |")
    lines.append("| Immediacy | Monitor / Action / Urgent | |")
    lines.append("")
    lines.append("### Recommended Actions")
    lines.append("- [ ] Add IOCs to blocklist")
    lines.append("- [ ] Create detection rule")
    lines.append("- [ ] Hunt in environment")
    lines.append("- [ ] Brief stakeholders")
    lines.append("- [ ] Update threat model")
    lines.append("- [ ] No action required")
    lines.append("")
    lines.append("### Analyst Notes")
    lines.append("```")
    lines.append("(Add any additional context, caveats, or observations here)")
    lines.append("```")
    lines.append("")
    ...
    lines.append("## MITRE ATT&CK Techniques (Auto + Validate)")
    lines.append("")
    if not inp.mitre.enabled:
        lines.append("_MITRE extraction is not available for this run (enterprise-attack.json missing)._")
        lines.append("")
    else:
